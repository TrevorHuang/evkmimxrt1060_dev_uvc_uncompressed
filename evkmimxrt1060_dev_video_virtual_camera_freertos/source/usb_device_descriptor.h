 ...
 * Definitions
 ******************************************************************************/
#define USB_DEVICE_VIDEO_CLASS_VERSION_1_1 (0)
...
#define FS_INTERRUPT_IN_INTERVAL    (0x01U)
...
#define USB_VIDEO_VIRTUAL_CAMERA_VC_PROCESSING_UNIT_LENGTH (0x00)//(0x0CU)
#define USB_VIDEO_VIRTUAL_CAMERA_VC_INPUT_TERMINAL_LENGTH (0x12U)

#else

#define USB_VIDEO_VIRTUAL_CAMERA_VC_PROCESSING_UNIT_LENGTH (0x00)//(0x0BU)
#define USB_VIDEO_VIRTUAL_CAMERA_VC_INPUT_TERMINAL_LENGTH (0x12U)
